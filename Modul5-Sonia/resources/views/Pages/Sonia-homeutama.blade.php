...
<!doctype html>
    ...
    <br>
        ...
        <div class="mb-3">
          ...
          <img src="logo-ead.png" style="width:100px;height:30px;float:left;margin-top:20px"/> <p style= "padding-left: 20px;margin-top:20px" >Sonia_1202200221</p>       
          </div>
        </div>
            </div>
        </div>
        ...
        <!-- Kanan -->
        <div class="col">
        <img src="Land Cruiser.jpg" class="rounded mx-auto d-block" height="300" weidth="100">
        </div>
    </div>
    </div>
</html>