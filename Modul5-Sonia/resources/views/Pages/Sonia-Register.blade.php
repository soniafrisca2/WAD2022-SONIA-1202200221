...
<html lang="en">
  ...
  <body>
    ...
    <div class="img" style="margin-left:0px;">
        <img src="Land Cruiser.jpg" style="transform: scaleX(-1);width: 700px; height: 713px;" alt="">
    </div>
        <form action="../Config/add_acc.php" method="post" style="width:50%;margin: 10px 50px">
            ...
            <p class="mb-4" style="text-align: left,">Anda sudah punya akun? <a href="../Pages/Sonia-Login.php">Login</a></p>
        </form>
    </div>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
  </body>
